...
tissuevs737_output <- generate_DE_results(dds, c("73.7","tissue" ))
res <-read.csv("C:\\Users\\SamGa\\Downloads\\FYP Stuff\\GSEA_Rfiles\\73.7_vs_tissue_allgenes.csv", header = T)
plot_volcano(res, 0.05, nlabel = 15, label.by = "padj","RGD73.7 vs tissue")
...
ranked_list <- read.table("C:\\Users\\SamGa\\Downloads\\FYP Stuff\\GSEA_Rfiles\\73.7_vs_tissue_rank.rnk", header = T, stringsAsFactors = F)
...
waterfall_plot(fgsea_results, "Hallmark pathways altered in 73.7 culture")
